...
_G.packer_plugins = {
  ...
  ["smart-pairs"] = {
    config = { "\27LJ\2\0027\0\0\2\0\3\0\a6\0\0\0'\1\1\0B\0\2\2\18\1\0\0009\0\2\0B\0\2\1K\0\1\0\nsetup\npairs\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/carter/.local/share/nvim/site/pack/packer/opt/smart-pairs",
